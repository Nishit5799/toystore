  ...
  return (
    <>
      <div className="flex flex-col gap-5 font-choco tracking-wider">
        <button
          className="btn mt-[15vw] text-sm sm:mt-1 text-md px-4 sm:px-8 sm:py-2 mx-auto  sm:text-xl sm:mb-10  text-white  sm:w-[9vw] rounded-full bg-black"
        ...
        <Link href={"/collection"}>
          <button
            className="btn  text-sm sm:mt-1 text-md px-4 sm:px-8 sm:py-2 mx-auto  sm:text-xl sm:mb-14 text-white sm:w-[9vw] rounded-full bg-black"
            onMouseEnter={handleMouseEnter}
            onMouseLeave={handleMouseLeave}
          >
